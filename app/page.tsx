...
const HomePage = (props: Props) => {
  ...
  return (
    ...
    <div className='flex h-screen'>
      ...
      تحضير الأشياء . . . <Rings height={50} color='red' />
      </div>}
    </div>
  )
  ...
  function RenderFeatureHighlightsSection() {
    return <div className="text-xs text-muted-foreground">
      <ul className="space-y-4">
        <li>
          <strong>الوضع الداكن/وضع النظام 🌗</strong>
          <p>التبديل بين الوضع المظلم و وضع النظام.</p>
        ...
        <li>
          <strong>الوجه الأفقي ↔️</strong>
          <p>ضبط الاتجاه الأفقي.</p>
        ...
        <Separator />
        <li>
          <strong>يلتقط الصور 📸</strong>
          <p>التقط لقطات في أي لحظة من بث الفيديو.</p>
          <Button
        ...
        <li>
          <strong>تسجيل الفيديو يدويا 📽️</strong>
          <p>تسجيل مقاطع الفيديو يدويًا حسب الحاجة.</p>
          <Button className='h-6 w-6 my-2'
            variant={isRecording ? 'destructive' : 'outline'} size={'icon'}
            onClick={userPromptRecord}
          >
        ...
        <Separator />
        <li>
          <strong>تمكين/تعطيل التسجيل التلقائي 🚫</strong>
          <p>
          خيار لتمكين/تعطيل تسجيل الفيديو التلقائي في أي وقت
             مطلوب.
          </p>
          <Button className='h-6 w-6 my-2'
            variant={autoRecordEnabled ? 'destructive' : 'outline'}
        ...
        <li>
          <strong>حجم الصوت 🔊</strong>
          <p>ضبط مستوى صوت الإخطارات.</p>
        </li>
        <li>
          <strong>تسليط الضوء على تغذية الكاميرا 🎨</strong>
          <p>
          يسلط الضوء على الأشخاص في{" "}
            <span style={{ color: "#FF0F0F" }}>أحمر</span> وأشياء أخرى في{" "}
            <span style={{ color: "#00B612" }}>أخضر</span>.
          </p>
        </li>
        <Separator />
        <li className="space-y-4">
          <strong>شارك افكارك 💬 </strong>
          <SocialMediaLinks/>
          <br />
          <br />
          <br />
